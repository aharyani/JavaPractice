package com.ammar.development.training.assignment.task3.langpackage.problem.one;
...
public class StringLiteralnObject {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("using .equals compare the value or content ---> "+ (strLiteral1.equals(strLiteral2)));//compare value or content of object
        System.out.println("using == compare the memory reference -------> "+ (strLiteral1==strLiteral2));//compare the memory reference
